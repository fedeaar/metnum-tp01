...
\vspace{2em}
\subsubsection{Escenario 3: Todos con Uno} Todas las páginas en la web tendrán un enlace dirigido hacia una única otra página.

\vspace{1em}
\fig[]{files/src/media/conceptuales/todos_a_uno_3.png}{Una web dónde todas lás páginas apuntan a una sola.}{todos_a_una}{0.25}
...
\vspace{2em}
\subsubsection{Escenario 4: Uno con Todos} Una única página con enlaces salientes hacia todas las demás.

\vspace{1em}
\fig[]{files/src/media/conceptuales/uno_a_todos_3.png}{Una web dónde una única página apunta a todo el resto.}{una_a_todos}{0.25}
