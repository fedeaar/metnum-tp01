...
\vspace{1em}
\fig[]{files/src/media/conceptuales/todos_con_todos.png}{Una web centralizada, donde todos señalan a la misma página.}{todos_con_todos}{0.26}
...
\vspace{1em}
\fig[]{files/src/media/conceptuales/todos_con_todos.png}{Una web muy simétrica, donde todos, excepto \textit{'uno'} poseen el ranking máximo.}{todos_con_todos}{0.26}
